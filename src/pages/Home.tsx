        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8 py-16 md:py-24 grid md:grid-cols-5 gap-10 items-center">
          <div className="md:col-span-3">
            ...
            <p className="mt-6 text-lg text-ink-soft max-w-xl leading-relaxed">
              Cuan Dari Gratisan adalah jaringan <strong>Paid-to-Click</strong> milik anak negeri. Lihat iklan 30 detik, kumpulkan saldo, tarik ke bank, e-wallet, atau kripto.
            </p>
      ...
      <section className="border-b-2 border-ink bg-cream">
        <div className="max-w-7xl mx-auto px-4 md:px-8 py-16">
          <div className="flex items-baseline justify-between mb-10 flex-wrap gap-2">
            ...
            <span className="font-mono text-xs uppercase tracking-widest text-ink-soft"><a href="https://cuandarigratisan.xo.je" target="blank">FORUM</a></span>
          </div>
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              { n: '03', t: 'Withdraw', d: 'Tarik saldo ke Bank, E-Wallet (BANK/DANA/GoPay) atau USDT crypto.' },
            ].map(s => (
